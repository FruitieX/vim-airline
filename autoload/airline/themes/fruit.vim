...
let s:N1 = [ '#141413' , '#CAE682' , 242, '' ] " mode
let s:N2 = [ '#CAE682' , '#32322F' , 242 , '' ] " info
let s:N3 = [ '#CAE682' , '#242424' , 242 , '' ] " statusline
let s:N4 = [ '#86CD74' , 9 ]                   " mode modified

" Insert mode
let s:I1 = [ '#141413' , '#CAE682' , 252, '' ] " mode
let s:I2 = [ '#FDE76E' , '#32322F' , 252 , '' ]
let s:I3 = [ '#FDE76E' , '#242424' , 252 , '' ]
let s:I4 = [ '#FADE3E' , 9 ]

" Visual mode
let s:V1 = [ '#141413' , '#CAE682' , 252, '' ] " mode
let s:V2 = [ '#FDE76E' , '#32322F' , 252 , '' ]
let s:V3 = [ '#FDE76E' , '#242424' , 252 , '' ]
let s:V4 = [ '#FADE3E' , 9 ]

" Replace mode
let s:R1 = [ '#141413' , '#CAE682' , 1, '' ] " mode
let s:R2 = [ '#FDE76E' , '#32322F' , 1 , '' ]
let s:R3 = [ '#FDE76E' , '#242424' , 1 , '' ]
let s:R4 = [ '#FADE3E' , 9 ]
...
let g:airline#themes#fruit#palette.normal_modified = {
    \ 'airline_a': [ s:N1[0] , s:N4[0] , s:N1[2] , '', ''     ] ,
    \ 'airline_b': [ s:N4[0] , s:IM[0] , s:N4[1] , '', ''     ] ,
    \ 'airline_c': [ s:N4[0] , s:N3[1] , s:N4[1] , '', ''     ] }
...
let g:airline#themes#fruit#palette.insert_modified = {
    \ 'airline_a': [ s:I1[0] , s:I4[0] , s:I1[2] , '', ''     ] ,
    \ 'airline_b': [ s:I4[0] , s:IM[0] , s:I4[1] , '', ''     ] ,
    \ 'airline_c': [ s:I4[0] , s:N3[1] , s:I4[1] , '', ''     ] }
...
let g:airline#themes#fruit#palette.visual_modified = {
    \ 'airline_a': [ s:V1[0] , s:V4[0] , s:V1[2] , '', ''     ] ,
    \ 'airline_b': [ s:V4[0] , s:IM[0] , s:V4[1] , '', ''     ] ,
    \ 'airline_c': [ s:V4[0] , s:N3[1] , s:V4[1] , '', ''     ] }
...
let g:airline#themes#fruit#palette.replace_modified = {
    \ 'airline_a': [ s:R1[0] , s:R4[0] , s:R1[2] , '', ''     ] ,
    \ 'airline_b': [ s:R4[0] , s:IM[0] , s:R4[1] , '', ''     ] ,
    \ 'airline_c': [ s:R4[0] , s:N3[1] , s:R4[1] , '', ''     ] }


let g:airline#themes#fruit#palette.insert_paste = {
    \ 'airline_a': [ s:I1[0] , s:PA[0] , s:I1[2] , '', ''     ] ,
    \ 'airline_b': [ s:PA[0] , s:IM[0] , s:PA[1] , '', ''     ] ,
    \ 'airline_c': [ s:PA[0] , s:N3[1] , s:PA[1] , '', ''     ] }
